...
export const Hero = () => {
  ...
  return (
    <div className='w-full bg-[#f6be00] text-black overflow-x-hidden px-6 min-h-svh flex items-center'>
      <div className='max-w-[1400px] w-full mx-auto pt-40 pb-28'>
        <div className='grid lg:grid-cols-2 gap-16 items-center relative'>
          ...
          >
            <motion.div
              className='inline-flex flex-col lg:flex-row items-center gap-2 bg-[#d0f5da] p-2 self-center lg:self-start'
              variants={textItemVariants}
            >
              <Star
                className='w-5 h-5 text-[#eb9b4a] hidden lg:block'
                fill='#eb9b4a'
              />
