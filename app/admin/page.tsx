...
import { Calendar, ChevronLeft, ChevronRight, Plus, X, Lock } from "lucide-react";
                  ...
                  {workHours.map((hour) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-1 text-xs text-gray-500">{booked ? "Reservado" : isPast ? "Pasado" : "Disponible"}</div>
                      </button>
                    );
                  })}
                </div>
